...
images into glitch art.`,
		...
		action: {
			url: 'https://drive.google.com/file/d/1CjNhSRMcS68CHHoQ-acVNu2kxpIYOFol/view?usp=sharing',
			text: 'Download',
			icon: download,
		},
	},
...
the frontend design and development.`,
		...
		action: {
			url: 'https://play.google.com/store/apps/details?id=com.kieranharte.meeco',
			text: 'Download',
			icon: playStore,
		},
	},
...
experience, and audio performance of each.`,
	...
	},
	{
		...
		description: html`I recently worked part-time as a freelance web developer
for sound artist and academic researcher Ximena Alarcón. My role was to
take an existing prototype of her app "INTIMAL App" and turn it into a
fully featured production-ready progressive web app (<b>PWA</b>). I chose
to use <b>React + MobX</b> for the front-end, hooked up to a
